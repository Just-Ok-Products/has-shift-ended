# Piano di sviluppo — feature mancanti

Indice del piano dettagliato per le 3 feature mancanti indicate in `CLAUDE.md`.

**Stato: tutte e 3 implementate** (2026-09-18), in ordine sequenziale per via delle dipendenze condivise (stesse righe di `home.component.ts`, Dockerfile prerequisito del workflow CI/CD). Modifiche presenti nel working tree, non ancora committate.
